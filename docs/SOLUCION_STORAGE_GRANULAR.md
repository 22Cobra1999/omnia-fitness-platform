# 🎯 Solución: Tracking de Archivos por Archivo Individual
...
- Video A solo está en actividad 90
- Video B solo está en actividad 59
...
Crear una nueva tabla `storage_files` que rastrea **cada archivo individual** y **en qué actividades se usa**.
...
```sql
-- Video único "abc-123" usado en actividad 90
...
**¡Ahora sí es correcto!** Solo muestra actividades que **realmente** usan esos archivos.
...
### Paso 2: Poblar con datos históricos
...
1. ✅ **Granular:** Sabes exactamente qué archivo usa qué actividad
2. ✅ **Deduplicable:** Mismo video usado en 2 lugares se cuenta 1 vez
3. ✅ **Rastreable:** Encuentras archivos huérfanos fácilmente
4. ✅ **Auditable:** Ves historial de uso de cada archivo
5. ✅ **Limpieza:** Puedes eliminar archivos no usados automáticamente

---

## ⚠️ Cómo Ver Tus Datos Actuales

He creado el archivo `QUERIES_DEBUG_STORAGE.sql` con queries para ver:
- Qué archivos reales tienes
- En qué actividades están
- La diferencia entre lo que dice `storage_usage` vs la realidad

Ejecuta esas queries en Supabase SQL Editor para entender tu situación actual.
...
2. Revisa `PROPUESTA_STORAGE_GRANULAR.md` para detalles técnicos
