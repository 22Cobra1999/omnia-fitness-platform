...
export function ChatWithCoach() {
  const [messages, setMessages] = useState<Message[]>([
    {
      sender: "coach",
      content: "Hello! I'm your nutrition coach. How can I help you today?",
      timestamp: new Date(),
    },
  ])
      ...
      setTimeout(() => {
        setMessages((prev) => [
          ...prev,
          {
            sender: "coach",
            content:
              "Thank you for your message. I'll review your nutrition plan and get back to you shortly with personalized advice.",
            timestamp: new Date(),
          },
        ])
      }, 1000)
