          ...
          >
            ...
            <div className="relative">
              ...
              <div className="relative z-10">
                ...
                {/* Certifications Section (Ahora va primero) */}
                ...
                {/* Statistics Section (Ahora va segundo y más completo) */}
                <div className="px-6 mb-6">
                  ...
                  <AnimatePresence>
                    {isStatsOpen && (
                      ...
                      >
                        <div className="pt-2">
                          <div className="text-[10px] text-white/40 mb-2 uppercase tracking-wider font-bold">Últimos 30 días</div>
