    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          className="fixed inset-0 bg-black/80 backdrop-blur-md z-[5000] flex items-center justify-center p-2 sm:p-6"
          onClick={(e) => {
        ...
        >
          <motion.div
            ...
            className="bg-[#0B0B0B] rounded-[32px] w-full h-full sm:h-auto max-h-full sm:max-h-[85vh] sm:max-w-[1200px] overflow-hidden flex flex-col border border-white/10 shadow-[0_32px_128px_-10px_rgba(0,0,0,0.8)]"
