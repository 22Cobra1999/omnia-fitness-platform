    ...
    return (
        <div className="fixed inset-0 z-[6000] flex items-center justify-center p-4 bg-black/80 backdrop-blur-md">
            <motion.div
                ...
                className="bg-[#0B0B0B] border border-white/10 p-8 rounded-[32px] max-w-sm w-full shadow-2xl relative overflow-hidden"
                onClick={(e) => e.stopPropagation()}
            >
                {/* Decorative Background Glow */}
                <div className="absolute -top-24 -right-24 w-48 h-48 bg-[#FF7939]/10 blur-[60px] rounded-full pointer-events-none" />

                <h3 className="text-2xl font-black text-white mb-2 tracking-tight">Seleccionar fuente</h3>
                <p className="text-sm text-gray-500 mb-8 leading-relaxed">
                    Elegí si querés usar un archivo existente o subir uno nuevo desde tu {mediaType === 'video' ? 'galería' : 'dispositivo'}.
                </p>
                ...
                <div className="space-y-3">
                    ...
                    >
                        ...
                        <div className="relative text-left">
                            <div className="text-sm font-bold text-white group-hover:text-[#FF7939] transition-colors">Existentes</div>
                            <div className="text-[10px] text-gray-500 font-medium">De tu biblioteca</div>
                        </div>
                    </button>
                    ...
                    <div className="relative">
                        ...
                        />
                        <div className="w-full group relative flex items-center gap-4 p-5 rounded-2xl border border-white/5 bg-white/[0.03] hover:bg-white/[0.08] hover:border-[#FF7939]/30 transition-all duration-300 overflow-hidden">
                            <div className="absolute inset-0 bg-gradient-to-r from-[#FF7939]/0 to-[#FF7939]/5 opacity-0 group-hover:opacity-100 transition-opacity" />
                            <div className="relative p-3 rounded-xl bg-white/5 border border-white/5 group-hover:bg-[#FF7939]/10 group-hover:border-[#FF7939]/20 transition-all">
                            ...
                            <div className="relative text-left">
                                ...
                                <div className="text-[10px] text-gray-500 font-medium">Desde este dispositivo</div>
                            </div>
                        </div>
                    </div>
...
export const CloseConfirmationModal: React.FC<CloseConfirmationModalProps> = ({
    ...
    return (
        <div className="fixed inset-0 z-[6000] flex items-center justify-center p-4 bg-black/80 backdrop-blur-xl">
            <motion.div
