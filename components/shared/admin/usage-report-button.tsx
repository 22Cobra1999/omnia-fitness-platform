...
import { usageTracker } from '@/lib/logging/usage-tracker'
  ...
  if (!showReport) {
    return (
      <button
        ...
        className="fixed bottom-20 left-4 z-50 bg-purple-600 hover:bg-purple-700 text-white p-3 rounded-full shadow-lg transition-all"
