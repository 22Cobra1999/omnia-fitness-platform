        ...
        <>
            <Dialog open={isOpen} onOpenChange={handleCloseAttempt}>
                <DialogContent className="w-[95vw] max-w-[480px] p-0 overflow-hidden bg-black/60 backdrop-blur-2xl border-white/10 text-white shadow-2xl rounded-3xl">
                    <div className="absolute top-0 left-0 right-0 z-20 px-6 py-4 flex items-center justify-between bg-gradient-to-b from-black/80 to-transparent">
                        ...
                        <div className="flex items-center gap-2">
                            <Button
                                ...
                                disabled={loading}
                                className="bg-[#FF7939] hover:bg-[#FF7939]/90 text-black font-medium text-xs rounded-full px-4 h-8 transition-all shadow-lg"
                            >
                                {loading ? "..." : "Guardar"}
                            </Button>
                    ...
                    <DialogDescription className="sr-only">Formulario para editar la información personal, física y metas del usuario.</DialogDescription>
