...
export function AutoUsageTracker() {
  useEffect(() => {
    ...
    window.__clearUsageReport = () => {
      ...
      console.log('🧹 Reporte de uso limpiado')
    }
    
    console.log('✅ Sistema de rastreo de uso activado')
    console.log('📊 Usa window.__getUsageReport() para ver el reporte')
    console.log('🧹 Usa window.__clearUsageReport() para limpiar')
