-- =====================================================
-- DESHABILITAR TRIGGER Y MIGRAR fitness_exercises
-- =====================================================

-- =====================================================
-- PASO 1: DESHABILITAR TRIGGER TEMPORALMENTE
-- =====================================================

-- Deshabilitar trigger que valida duplicados
ALTER TABLE organizacion_ejercicios DISABLE TRIGGER trigger_validar_organizacion_ejercicios;
...
-- =====================================================
-- PASO 7: HABILITAR TRIGGER NUEVAMENTE
-- =====================================================

-- Habilitar trigger nuevamente
ALTER TABLE organizacion_ejercicios ENABLE TRIGGER trigger_validar_organizacion_ejercicios;
