-- Trigger completo para generar automáticamente períodos y ejecuciones
-- Se dispara cuando se inserta un nuevo enrollment en activity_enrollments
...
BEGIN
    ...
    INTO activity_record, coach_record
    FROM activities a
    ...
    -- PASO 2: Obtener ejercicios de la actividad
    FOR exercise_record IN 
        SELECT id, nombre_ejercicio, tipo
        FROM ejercicios_detalles 
        WHERE activity_id = NEW.activity_id
    LOOP
        -- PASO 3: Obtener períodos creados
