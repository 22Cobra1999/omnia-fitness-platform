-- =====================================================
-- CORREGIR CONSTRAINT DE TIPO Y MIGRAR fitness_exercises
-- =====================================================

-- =====================================================
-- PASO 1: CORREGIR CONSTRAINT DE TIPO
-- =====================================================

-- Eliminar constraint existente
ALTER TABLE ejercicios_detalles DROP CONSTRAINT IF EXISTS valid_tipo;

-- Crear nuevo constraint con más tipos
ALTER TABLE ejercicios_detalles ADD CONSTRAINT valid_tipo CHECK (
    tipo IN (
        'fuerza', 
        'cardio', 
        'movilidad', 
