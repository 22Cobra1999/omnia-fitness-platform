-- FIX CALENDAR EVENTS RLS (Recursive Loop) - ROBUST V4
...
-- V4: Added extra DROP statements to handle potentially conflicting policy names.
...
-- Drop ALL potential variations of conflicting policies
...
DROP POLICY IF EXISTS "Users can view open events" ON public.calendar_events; -- Added in V4
