-- Script corregido para poblar la nueva tabla intensidades
-- Basado en la estructura real de ejercicios_detalles
...
SELECT 
    ...
    ed.calorias, -- Usar las calorías del ejercicio
    ed.created_by
...
SELECT 
    ...
    ROUND(ed.calorias * 1.1) as calorias, -- Aumentar calorías en 10%
    ed.created_by
FROM ejercicios_detalles ed,
...
SELECT 
    ...
    30 as duracion_minutos,
    ROUND(ed.calorias * 1.2) as calorias, -- Aumentar calorías en 20%
    ed.created_by
FROM ejercicios_detalles ed,
     jsonb_array_elements(ed.detalle_series) as serie
WHERE ed.activity_id = 59
...
-- 5. Mostrar distribución por intensidad
SELECT 
    intensidad,
    COUNT(*) as cantidad,
