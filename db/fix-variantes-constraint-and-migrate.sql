-- =====================================================
-- CORREGIR CONSTRAINT DE VARIANTES Y MIGRAR fitness_exercises
-- =====================================================

-- =====================================================
-- PASO 1: CORREGIR CONSTRAINT DE VARIANTES
-- =====================================================

-- Eliminar constraint existente
ALTER TABLE ejercicios_detalles DROP CONSTRAINT IF EXISTS valid_variantes;

-- Crear nuevo constraint más flexible
ALTER TABLE ejercicios_detalles ADD CONSTRAINT valid_variantes CHECK (
    variantes IS NULL OR 
    jsonb_typeof(variantes) = 'object' OR 
