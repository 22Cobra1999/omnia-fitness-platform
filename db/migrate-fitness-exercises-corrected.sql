-- =====================================================
-- MIGRAR fitness_exercises CON ESTRUCTURA REAL
-- =====================================================
...
BEGIN
    ...
    IF v_table_exists THEN
        ...
        WHERE table_name = 'fitness_exercises'
        AND column_name IN ('id', 'activity_id', 'bloque', 'nombre_actividad', 'tipo_ejercicio', 'detalle_series');
...
-- =====================================================
-- PASO 5: CREAR EJECUCIONES PARA ENROLLMENTS EXISTENTES
-- =====================================================
