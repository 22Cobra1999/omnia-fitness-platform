-- =====================================================
-- CORREGIR PROBLEMAS FINALES
-- =====================================================

-- =====================================================
-- 1. DESHABILITAR TRIGGER DE INTENSIDADES
-- =====================================================

ALTER TABLE intensidades DISABLE TRIGGER trigger_validar_intensidades;

-- =====================================================
-- 2. MIGRAR INTENSIDADES
-- =====================================================
...
ALTER TABLE intensidades ENABLE TRIGGER trigger_validar_intensidades;
