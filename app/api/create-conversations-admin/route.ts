...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('💬 Creando conversaciones como admin (bypass RLS)...')
    ...
    return NextResponse.json({
      ...
      created_conversations: createdConversations.slice(0, 5),
      existing_conversation_keys: existingConversations.slice(0, 5)
    })
