...
export async function GET(
  ...
  try {
    ...
    const { data: enrollments, error: enrollmentsError } = await supabase
      ...
      .select('id, start_date, status, created_at, updated_at, expiration_date, start_deadline, current_streak, last_streak_date, activity_surveys(coach_method_rating, comments)')
